...
public class TestConstants {
	...
	public static final char[] KEYSTORE_TEST_PASSWD = "clavePrivada".toCharArray();
	public static final String KEYSTORE_FILE_JKS = "store-firmas/keystore-1203-01.ks";
	public static final String KEYSTORE_FILE_PKCS12 = "testdata/test-keystore.p12";

	public static final String KEY_PASSWD_SUFFIX = "clavePublica";
	...
	public static enum TestPrivateKey {
		...
		public char[] getPasswd() {
			return (KEY_PASSWD_SUFFIX).toCharArray();
		}
